...
const Home = userInfo => {
  const [classArray, onChangeClassArray] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(null);
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    console.log(userInfo.userInfo.id);

    if (userInfo !== '') {
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.get(`http://18.220.117.207:5000/class/:${userInfo.userInfo.id}`, {
        headers: {
...
module.exports = __webpack_require__(/*! D:\contest\shareboard\front\pages\index.js */"./pages/index.js");
