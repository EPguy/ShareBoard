...
var AppLayout = function AppLayout(_ref) {
  ...
  var _useInput5 = useInput(''),
      ...
      joinClassName = _useInput6[0],
      onChangeJoinClassName = _useInput6[1];
  ...
  var onJoin = function onJoin() {
    axios__WEBPACK_IMPORTED_MODULE_5___default.a.post("http://18.220.117.207:5000/class/join/:".concat(joinClassName), {
      header: {
        'token': react_cookies__WEBPACK_IMPORTED_MODULE_6___default.a.load('token')
      }
    }).then(function (response) {
      console.log(response);
  ...
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
    ...
    __self: this
  }, "\uAC00\uC785\uD560 \uD074\uB798\uC2A4\uBA85 \uC785\uB825"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_4__["Input"], {
    value: joinClassName,
...
//# sourceMappingURL=_app.js.09ac5a8cd6b6712896ba.hot-update.js.map